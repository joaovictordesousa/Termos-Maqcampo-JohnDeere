                ...
                <div class="p-6 text-gray-900">
                    <form class="row g-3" action="{{ route('index.update', ['termos' => $termos->id]) }}" method="POST"
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="usuario" value="{{ $termos->usuario }}"
                                id="campo" required>
                        </div>

                        <div class="col-md-4">
                            <label for="validationDefault02" class="form-label">Filial</label>
                            <input type="text" class="form-control" name="filial" value="{{ $termos->filial }}"
                                id="campo" required>
                        </div>

                        <div class="col-md-4">
                            <label for="validationDefault02" class="form-label">CPF</label>
                            <input type="text" class="form-control" name="cpf" minlength="11" maxlength="11"
                                value="{{ $termos->cpf }}" id="campo" required>
                        </div>

                        <div class="col-md-3">
                            <label for="validationDefault02" class="form-label">Numero de serie</label>
                            <input type="text" class="form-control" name="serie" value="{{ $termos->serie }}" id="campo"
                                required>
                        </div>
